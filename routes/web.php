...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('/finance/fees/challans/{feeChallan}/verify', [StudentPortalController::class, 'verifyFeeProof'])->name('finance.fees.challans.verify');
    ...
    // Attendance Engine Routes (Teacher & Admin)
    ...
    // Admin Institutional Master Attendance Reports
    ...
    Route::prefix('academics')->name('academics.')->group(function () {
        ...
        // Curriculum / Study Scheme Management
        ...
        // Sessions, Programs, Sections, Timetable, Results, and Calendar
